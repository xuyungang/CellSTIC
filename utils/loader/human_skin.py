"""
Human skin: load and preprocess RNA + ADT (no cell type annotation).
Call load_human_skin(raw_path, preprocess_path) to get (rna_adata, adt_adata).
"""
...
_TSV_NAMES = ("rna/GSM6578065_humanskin_RNA.tsv", "adt/GSM6578074_humanskin_protein.tsv")
...
def load_human_skin(
    ...
    """
    Load and preprocess human skin RNA + ADT. No cell type annotation.
